...
export async function get(id: string) {
  return requestClient.get(
    `${VITE_PROJECT_API_URL}/development/v1/online-table/${id}`,
  );
}

export async function save(data: object) {
  return requestClient.post(
    `${VITE_PROJECT_API_URL}/development/v1/online-table`,
    data,
  );
}
...
export async function saveTableAndColumns(data: object) {
  return requestClient.post(
    `${VITE_PROJECT_API_URL}/development/v1/online-table/saveTableAndColumns`,
    data,
  );
}
